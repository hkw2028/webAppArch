...
public class Test {
	...
	public static void main(String[] args) {
		...
		ser.save(new Customer(1110,"±è±èÃ¶¼ö","¼­¿ï"));
		ser.save(new Customer(1112,"±è¼ö","ºÎ»ê"));
		ser.save(new Customer(1113,"±èÃ¶","±¤ÁÖ"));
		ser.save(new Customer(1114,"±èÃ¶Ã¶¼ö","´ë±¸"));
		ser.save(new Customer(1115,"±èÃ¶¼ö¼ö","ÀÎÃµ"));
